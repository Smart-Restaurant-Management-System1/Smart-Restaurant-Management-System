  ...
  if (!imageUrl || imageError) {
    return (
      ...
      >
        ...
        <span style={{ fontSize: '0.72rem', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase', color: '#8c6736' }}>
...
function CustomerMenuPage() {
  ...
  return (
    <div className="page-container customer-menu-page" style={{ maxWidth: '1240px', margin: '0 auto' }}>
      {/* Luxury Page Header */}
      <PageHeader
        eyebrow="Artisanal Culinary Experience"
        title={<>Explore Our <em>Menu</em></>}
      ...
      <div className="customer-menu-category-ribbon">
        ...
        {CATEGORIES.map((cat) => (
          <button
            ...
            className={`bistro-category-pill ${category === cat ? 'active' : ''}`}
          >
            {CATEGORY_ICONS[cat]}
            <span>{cat}</span>
          </button>
      ...
      <section className="customer-menu-filter-card">
        ...
        <div className="form-group">
          <label htmlFor="customerMenuDietaryInfo">Dietary Preference</label>
          <select
          ...
          >
            ...
            {DIETARY_OPTIONS.map((dietaryOption) => (
              <option key={dietaryOption} value={dietaryOption}>
                {dietaryOption === 'None' ? 'Standard / All' : dietaryOption}
              </option>
            ))}
          </select>
        </div>
      ...
      <section className="customer-menu-results">
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            <h2 style={{ fontFamily: "Georgia, 'Times New Roman', serif", fontSize: '1.25rem', color: '#282115', margin: 0, fontWeight: 600 }}>
        ...
        {loading ? (
          ...
          >
            ...
            />
            <p style={{ color: '#78716c', fontSize: '0.95rem', fontStyle: 'italic', margin: 0 }}>
          ...
          >
            <p style={{ color: '#991b1b', marginBottom: '1rem' }}>We could not load the menu catalog.</p>
            <button
              type="button"
              className="bistro-button-gold"
              onClick={loadCustomerMenu}
          ...
          >
            ...
            <p style={{ color: '#78716c', maxWidth: '420px', fontSize: '0.88rem', margin: '0 0 1.25rem', lineHeight: 1.5 }}>
              There are no dishes matching your selected search or dietary filters. Try adjusting your preferences.
            </p>
            <button
              type="button"
              className="bistro-button-gold"
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <span style={{ fontSize: '0.7rem', fontWeight: 600, color: '#8c6736' }}>Rs.</span>
                      <span style={{ fontFamily: "Georgia, 'Times New Roman', serif", fontSize: '0.98rem', fontWeight: 700, color: '#282115' }}>
                  ...
                  >
                    <div className="customer-menu-card-heading" style={{ marginBottom: '0.45rem' }}>
                      <h3
                        style={{
                    ...
                    >
                      {item.description || 'Artisanal dish crafted with fresh seasonal ingredients.'}
                    </p>
