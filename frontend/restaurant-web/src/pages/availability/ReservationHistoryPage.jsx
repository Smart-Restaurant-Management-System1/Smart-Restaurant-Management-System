...
function ReservationCard({ reservation }) {
  return <article className="reservation-history-card">
    ...
    <Link className="btn-jelly-secondary" to={'/reservations/' + reservation.reservationId}>View or manage reservation</Link>
  </article>;
}
