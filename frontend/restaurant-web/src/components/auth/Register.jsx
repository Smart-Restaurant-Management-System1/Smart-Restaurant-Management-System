  ...
  return (
    <div className="fullscreen-auth-container">
      ...
      <div className="fullscreen-form-pane register-form-pane">
        ...
        <div className="fullscreen-form-wrapper register-form-wrapper">
          <div className="auth-form-title-group">
            ...
            <p>Start your culinary journey with Cinnamon Bistro</p>
          </div>
          ...
          <div className="fullscreen-tabs">
            <button
              type="button"
              className={`fullscreen-tab-btn ${accountType === 'Customer' ? 'active' : ''}`}
            ...
            <button
              type="button"
              className={`fullscreen-tab-btn ${accountType === 'Staff' ? 'active' : ''}`}
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className={`staff-expand-wrapper ${accountType === 'Staff' ? 'open' : ''}`}>
              <div className="staff-expand-inner">
                <div className="staff-fields-section fullscreen-staff-box">
                  <div className="form-row">
                    <div className="form-group">
      ...
      <div 
        ...
        style={{ backgroundImage: `url(${registrationIllustration})` }}
      >
